...
schema_run_python_file = types.FunctionDeclaration(
    ...
    description="Run a python file using the python interpreter. Needs to be a .py file.",
    parameters=types.Schema(
        type=types.Type.OBJECT,
        properties={
            "file_path": types.Schema(
                type=types.Type.STRING,
                description="Directory path to the file to be executed, relative to the working directory (default is the working directory itself)",
            ),
        },
        required=["file_path"],
    ),
